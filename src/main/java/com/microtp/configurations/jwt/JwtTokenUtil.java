package com.microtp.configurations.jwt;
...
public class JwtTokenUtil implements Serializable {
	...
	//Tiempo de validacion del token (5 Hs)
	public static final long JWT_TOKEN_VALIDITY = 5 * 60 * 60 *1000	;

	//Obtiene el valor de application.properties
	...
	//Con "claims" pueden cargarse mas datos al JWT
